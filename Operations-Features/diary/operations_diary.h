...
private:
    ...
    bool m_isShuttingDown = false;  // Flag to prevent error dialogs during shutdown
...
public:
    ...
    // Method to set shutdown state to prevent error dialogs
    void setShuttingDown(bool shuttingDown) { m_isShuttingDown = shuttingDown; }
